...
var urlbase = "<?php echo 'leo';?>";
var urlbasedefault = "<?php echo site_url('')?>";
if(urlbase == urlbasedefault){
    localStorage.setItem("simpanmenu", "dasboard");
}
//end set default url
alert(urlbase);
